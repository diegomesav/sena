!function(e, t) {
    ...
    var ie = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : W) !== E && Y(t),
            n = n || [],
            !e || "string" != typeof e)
                return n;
            if (1 !== (s = (t = t || E).nodeType) && 9 !== s)
                return [];
            if (A && !r) {
                if (i = ve.exec(e))
                    if (a = i[1]) {
        ...
        var _, b, x, k, S, T, D, M, C, N, O, Y, E, j, A, L, P, H, R, F = "sizzle" + -new Date, W = e.document, I = 0, U = 0, q = n(), V = n(), G = n(), $ = function(e, t) {
            return e === t && (O = !0),
            0
        ...
        t.contains = function(e, t) {
            return (e.ownerDocument || e) !== E && Y(e),
            R(e, t)
        }
        ,
        t.attr = function(e, t) {
    ...
    var We, Ie = {}, Ue = /^margin/, qe = new RegExp("^(" + xe + ")(?!px)[a-z%]+$","i"), Ve = function(e) {
    ...
    K.each(["height", "width"], (function(e, t) {
        K.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return Ge.test(K.css(e, "display")) && 0 === e.offsetWidth ? K.swap(e, ze, (function() {
                        return D(e, t, r)
                    }
                    )) : D(e, t, r)
            },
    ...
    K.fx.step = {};
    var Je, Qe, Ke = /^(?:toggle|show|hide)$/, et = new RegExp("^(?:([+-])=|)(" + xe + ")([a-z%]*)$","i"), tt = /queueHooks$/, nt = [E], rt = {
        "*": [function(e, t) {
...
function(e, t) {
    ...
    function Ze(e) {
        for (var t = e && Ee(e, qt).length || 0, n = Array(t), r = 0; r < t; r++)
            n[r] = Oe(e, r);
        return n
    }
    function Xe(e, t) {
...
function(e, t) {
    ...
    function z(e, t, n) {
        e.isValid() && !isNaN(n) && ("FullYear" === t && q(e.year()) && 1 === e.month() && 29 === e.date() ? (n = G(n),
    ...
    function at(e) {
        var t, n = e._a;
        return n && -2 === h(e).overflow && (t = n[Wi] < 0 || n[Wi] > 11 ? Wi : n[Ii] < 1 || n[Ii] > oe(n[Fi], n[Wi]) ? Ii : n[Ui] < 0 || n[Ui] > 24 || 24 === n[Ui] && (0 !== n[qi] || 0 !== n[Vi] || 0 !== n[Gi]) ? Ui : n[qi] < 0 || n[qi] > 59 ? qi : n[Vi] < 0 || n[Vi] > 59 ? Vi : n[Gi] < 0 || n[Gi] > 999 ? Gi : -1,
    ...
    function yt(e) {
        ...
        if (!e._d) {
            ...
            24 === e._a[Ui] && 0 === e._a[qi] && 0 === e._a[Vi] && 0 === e._a[Gi] && (e._nextDay = !0,
            e._a[Ui] = 0),
    ...
    function Ln(t) {
        ...
        case "hour":
            n = this._d.valueOf(),
            n -= En(n + (this._isUTC ? 0 : this.utcOffset() * jo), Ao);
            break;
        case "minute":
            n = this._d.valueOf(),
            n -= En(n, jo);
    ...
    function Pn(t) {
        ...
        case "hour":
            n = this._d.valueOf(),
            n += Ao - En(n + (this._isUTC ? 0 : this.utcOffset() * jo), Ao) - 1;
            break;
        case "minute":
            n = this._d.valueOf(),
            n += jo - En(n, jo) - 1;
    ...
    var si, ui = {
        ...
        y: "a year",
        yy: "%d years"
    }, vi = {}, wi = {}, _i = /\d/, bi = /\d\d/, xi = /\d{3}/, ki = /\d{4}/, Si = /[+-]?\d{6}/, Ti = /\d\d?/, Di = /\d\d\d\d?/, Mi = /\d\d\d\d\d\d?/, Ci = /\d{1,3}/, Ni = /\d{1,4}/, Oi = /[+-]?\d{1,6}/, Yi = /\d+/, Ei = /[+-]?\d+/, ji = /Z|[+-]\d\d:?\d\d/gi, Ai = /Z|[+-]\d\d(?::?\d\d)?/gi, Li = /[+-]?\d+(\.\d{1,3})?/, Pi = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i;
    si = {};
    var Hi, Ri = {}, Fi = 0, Wi = 1, Ii = 2, Ui = 3, qi = 4, Vi = 5, Gi = 6, $i = 7, Bi = 8;
    ...
    var qo = Math.abs
      ...
      , ua = Math.abs
      , la = At.prototype;
    return la.isValid = Et,
    la.abs = jr,
    la.add = Lr,
    la.subtract = Pr,
    la.as = Ir,
    la.asMilliseconds = Vo,
    la.asSeconds = Go,
    la.asMinutes = $o,
    la.asHours = Bo,
    la.asDays = zo,
