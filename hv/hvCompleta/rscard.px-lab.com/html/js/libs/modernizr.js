 ...
 * http://modernizr.com/download/?-bgrepeatspace_bgrepeatround-boxshadow-cssall-cssanimations-cssgradients-csstransforms-csstransforms3d-csstransitions-opacity-rgba-textshadow !*/
 !function(e, t, n) {
    ...
    function l(e, n, r, s) {
        ...
        w.style.overflow = l,
        w.offsetHeight) : p.parentNode.removeChild(p),
        !!a
    }
    function u(e, t) {
        return function() {
    ...
    function h(e, t, n, s, o) {
        ...
        return r(t, "string") || r(t, "undefined") ? g(a, t, s, o) : (a = (e + " " + E.join(i + " ") + i).split(" "),
        p(a, t, n))
    }
    function v(e, t, r) {
        return h(e, n, n, t, r)
    ...
    Modernizr.addTest("cssgradients", function() {
        for (var e, t = "background-image:", n = "gradient(linear,left top,right bottom,from(#9f9),to(white));", r = "", s = 0, o = S.length - 1; o > s; s++)
            e = 0 === s ? "to " : "",
